...
global.sudo = process.env.SUDO || "2349023267934";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`QUEEN_Samskid™`",
  author: process.env.PACK_AUTHER || "HAKI",
  packname: process.env.PACK_NAME || "SAMSKID_UNIVERSE",
  botname: process.env.BOT_NAME || "QUEEN_SAMSKID",
  ownername: process.env.OWNER_NAME || "HAKI_SANSKID",
